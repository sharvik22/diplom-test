...
Скрипт передает ключи из вывода, сохраняет их во временный файл, выводит мне для проверки и экспорта переменные и удаляет файл в котором есть секретные ключи.
